...
final class RemoteLauncher extends Launcher {
    ...
    public Proc launch(ProcStarter ps) throws IOException {
        ...
        t1.start();
        final Thread t2 = new StreamCopyThread("stderr copier: " + name, session.getStderr(),
            defaulted(ps.stderr(), ps.stdout()), false);
        t2.start();
    ...
    public Channel launchChannel(String[] cmd, OutputStream out, FilePath _workDir, Map<String, String> envVars)
